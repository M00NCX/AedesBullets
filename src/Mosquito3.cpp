...
Mosquito3::Mosquito3() : spriteSheet("./img/mosquito.png"), x(200), y(500), visible(false), direction(-1)
{
...
void Mosquito3::render(int pose)
{
    if (!visible)
...
void Mosquito3::setVisible(bool visible)
{
    this->visible = visible;
}

bool Mosquito3::checkCollision(float x, float y, float width, float height)
{
